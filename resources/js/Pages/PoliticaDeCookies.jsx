        ...
        <>
            ...
            <div className="container px-4 py-8 mx-auto mt-16 md:mt-24 lg:mt-32">
                ...
                <section className="mb-8">
                    ...
                    <p>Si tienes alguna pregunta sobre nuestra Política de Cookies, puedes contactarnos en: <a href="mailto:alianzafe24@gmail.com" className="text-blue-500 underline">alianzafe24@gmail.com</a></p>
