        ...
        <div className="py-8 bg-gray-50">
            <div className="container px-4 mx-auto">
                <div className="p-6 bg-white rounded-lg shadow-md">
                    <h1 className="mb-4 text-3xl font-bold">Apache License</h1>
                    ...
                    <div className="prose max-w-none">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                normally appear. The contents of the NOTICE file
                        ...
                        <p>
                            ...
                            following boilerplate notice, with the fields
                            enclosed by brackets "[]" replaced with your own
                            identifying information. (Don't include the
                            brackets!) The text should be enclosed in the
                            appropriate comment syntax for the file format. We
                            also recommend that a file or class name and
                            description of purpose be included on the same
